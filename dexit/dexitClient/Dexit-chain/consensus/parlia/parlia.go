...
func (p *Parlia) IsSystemTransaction(tx *types.Transaction, header *types.Header) (bool, error) {
	// deploy a contract
	fmt.Println("IsSystemTransaction is working with PoA")
	if tx.To() == nil {
		return false, nil
	}
...
func (p *Parlia) IsSystemContract(to *common.Address) bool {
	fmt.Println("IsSystemContract is working with PoA")
	if to == nil {
		return false
	}
...
func (p *Parlia) EnoughDistance(chain consensus.ChainReader, header *types.Header) bool {
	fmt.Println("EnoughDistance is working with PoA")
...
func (p *Parlia) AllowLightProcess(chain consensus.ChainReader, currentHeader *types.Header) bool {
	...
	fmt.Println("AllowLightProcess is working with PoA")
	if err != nil {
		return true
	}
...
func (p *Parlia) IsLocalBlock(header *types.Header) bool {
	fmt.Println("IsLocalBlock is working with PoA")
